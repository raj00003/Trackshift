...
pub mod job_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("trackshift.jobs.JobService", "CreateJob"));
        ...
        pub async fn get_job(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("trackshift.jobs.JobService", "GetJob"));
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("trackshift.jobs.JobService", "ListJobs"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod job_service_server {
    ...
    impl<T: JobService> tonic::server::NamedService for JobServiceServer<T> {
        const NAME: &'static str = "trackshift.jobs.JobService";
    }
}
